          ...
          <div>
              ...
              <div id="invoiceContent">
                  ...
                  <div class="row" style="margin-top:10px;">
                      <div class="col-xs-7">
                          <table _a584de :style="{display: returnCart.length > 0 ? '':'none'}">
                              <thead>                            
                                  <tr>
                                      <td colspan="5" style="background:#eee">Return Details</td>
                                  </tr>
                                  <tr>
                                      <td>Sl.</td>
                                      <td>Description</td>
                              ...
                              <tbody>
                                  <tr style="color: #cd0000" v-for="(product1, sln) in returnCart">
                                      <template v-if="returnCart[0].SaleReturnDetailsProduct_SlNo != null">
                                          <td>{{ sln + 1 }}</td>
                                          <td style="text-align:left">{{ product1.Product_Name }}</td>
                                          <td style="text-align:center">{{ 'Return' }}</td>
                                          <td>{{ product1.SaleReturnDetails_ReturnQuantity }}</td>
                                          <td>{{ product1.SaleReturnDetails_ReturnAmount }}</td>
                                      </template>
                                  </tr>
                                  <tr style="font-weight:bold;"> 
                                      <td colspan="3" style="text-align:right;"> Total = </td>
                                      <td>{{ returnCart.reduce((prev, curr) => { return prev + +curr.SaleReturnDetails_ReturnQuantity},0)  }}</td>
                                      <td>{{ returnCart.reduce((prev, curr) => { return prev + +curr.SaleReturnDetails_ReturnAmount},0)  }}</td>
                                  </tr>
                              </tbody>
                          </table>                        
                      </div>
                      <div class="col-xs-5">
                          <table _t92sadbc2>
                              ...
                              <tr>
                                  ...
                                  <td style="text-align:right">({{ sales.SaleMaster_ReturnAmount }})</td>
                              </tr>
                              <tr>
                  ...
                  <div class="row">
                        <div class="col-xs-4 duePart">
                          <table class="pull-right tableDue">
                              <tr>
    ...
    methods: {
      getSales() {
        axios.post("/get_sales", { salesId: this.sales_id }).then((res) => {
          ...
          this.sales.SaleMaster_SaleDate = moment(
            this.sales.SaleMaster_SaleDate
          ).format("DD/MM/YYYY");
          this.cart = res.data.saleDetails;
          this.returnCart = res.data.salesReturn;
        });
      },
      getCurrentBranch() {
                              ...
                              <table style="width:100%;">
                                  <thead>
                                      <tr>
                                          <td>
                                              <div class="row">
                                                  <div class="col-xs-2"><img src="/uploads/Branch/${
                                                    this.currentBranch.Branch_Logo
