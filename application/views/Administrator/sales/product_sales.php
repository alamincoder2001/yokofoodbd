...
<div id="sales" class="row">
	<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
		<div class="row">
			...
			<div class="form-group">
			<label class="col-xs-4 col-lg-1 control-label no-padding-right"> Date </label>
				<div class="col-xs-8 col-lg-2">
	...
	new Vue({
		...
		methods: {
			...
			async saveSales() {
				...
				if (this.sales.SaleMaster_Bill_no == '') {
			...
			async getSales() {
				await axios.post('/get_sales', {
					...
					this.sales.SaleMaster_Bill_no = sales.SaleMaster_Bill_no;
