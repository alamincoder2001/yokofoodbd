	...
	<form @submit.prevent="saveCustomer">
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom:15px;">
			...
			<div class="col-md-5">
				...
				<div class="form-group clearfix">
					<label class="control-label col-md-4">Marketing Officer:</label>
					<div class="col-md-7">
						<v-select v-bind:options="employees" v-model="selectedEmployee" label="Employee_Name" @input="changeEmployee"></v-select>
					</div>
